#!/usr/bin/env python3
"""
Standalone script wrapper for boj-crawler package batch functionality.
This script provides the same functionality as the package's batch CLI but as a standalone script.
"""
...
try:
    from boj_crawler import batch_crawl, read_usernames
except ImportError:
